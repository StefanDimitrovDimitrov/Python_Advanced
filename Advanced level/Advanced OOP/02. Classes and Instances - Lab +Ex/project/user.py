...
class User:
    ...
    def get_book(self, author: str, book_name: str, days_to_return: int, library: Library):
        if author in library.books_available and book_name in library.books.available[author]:
            self.books.append(book_name)

            if self.username not in library.rented_books:
                library.rented.books[self.username] = {}
    ...
    def return_book(self,author:str, book_name:str, library: Library):
        ...
        del library.rented.books[self.username][book_name]
